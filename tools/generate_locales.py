#!/usr/bin/env python3
"""Generate a compact header-only C++ locale table from mishmesh/locales/*.json.
...
def cpp_string(value: str) -> str:
    # JSON escaping is valid for the accepted C++ string characters. Keeping
    # ensure_ascii=False leaves source files readable and preserves UTF-8.
...
def main() -> int:
    ...
    try:
        ...
        return 0 if write_or_check(HEADER_PATH, generate_header(keys, locales), args.check) else 1
